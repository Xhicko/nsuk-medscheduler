...
export default function AdminVerificationEmail({ systemName, token, supportEmail }) {
  ...
  return (
    <Html>
      <Head />
      <Preview>{`${safeSystemName}: Admin email verification code`}</Preview>
        ...
        <Container style={styles.container}>
          ...
          <Section>
            ...
            <Text style={styles.paragraph}>
              Use the 8-digit code below to continue creating your admin account. This code expires in 3 minutes.
            </Text>
          </Section>
          ...
          <Section style={styles.card}>
            ...
            <Text style={styles.value}>If you didn’t request this, you can ignore this email.</Text>
          </Section>
