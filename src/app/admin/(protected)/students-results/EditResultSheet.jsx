...
import { User2, Save, Loader } from "lucide-react"
import { Input } from '@/components/ui/input'
import { Separator } from "@/components/ui/separator"
import { Controller } from "react-hook-form"

export default function EditResultSheet({ 
   isOpen,
   onOpenChange,
   formData,
   title,
   ...
   const { control, handleSubmit, formState: { errors, isSubmitting }, register, clearErrors, trigger } = editResultForm
           ...
           <SheetHeader className="px-6 py-4">
             <div className="flex items-start justify-between gap-3">
               <div className="flex items-start gap-3">
                 ...
                 <div>
                   <SheetTitle className="text-xl font-extrabold text-[#0077B6]">{title || "Edit Medical Results"}</SheetTitle>
                   <SheetDescription className="text-gray-600">
                    Update medical test results for <span className="font-medium text-[#0077B6]">{formData?.student_name || "this student"}</span>
                   </SheetDescription>
                 </div>
               </div>
             </div>
               ...
               <div className="flex gap-2">
                 <Controller
                   ...
                   render={({ field }) => (
                     ...
                     >
                       <SelectTrigger className={cn("w-[70%]", errors.hemoglobinStatus && "border-red-500")}>
               ...
               <div className="flex gap-2">
                 <Controller
                   ...
                   render={({ field }) => (
                     ...
                     >
                       <SelectTrigger className={cn("w-[70%]", errors.wbcStatus && "border-red-500")}>
                         <SelectValue placeholder="Status" />
                       </SelectTrigger>
                       <SelectContent>
                         {STATUS_OPTIONS.map((status) => (
               ...
               <div className="flex gap-2">
                 <Controller
                   ...
                   render={({ field }) => (
                     ...
                     >
                       <SelectTrigger className={cn("w-[70%]", errors.plateletsStatus && "border-red-500")}>
                         <SelectValue placeholder="Status" />
                       </SelectTrigger>
                       <SelectContent>
                         {STATUS_OPTIONS.map((status) => (
               ...
               <div className="flex gap-2">
                 <Controller
                   ...
                   render={({ field }) => (
                     ...
                     >
                       <SelectTrigger className={cn("w-[70%]", errors.bloodSugarStatus && "border-red-500")}>
                         <SelectValue placeholder="Status" />
                       </SelectTrigger>
                       <SelectContent>
                         {STATUS_OPTIONS.map((status) => (
             ...
             <div className="space-y-2">
               ...
               <Controller
                 ...
                 render={({ field }) => (
                   ...
                   >
                     <SelectTrigger className={cn("w-full", errors.hivResult && "border-red-500")}>
             ...
             <div className="space-y-2">
               ...
               <Controller
                 ...
                 render={({ field }) => (
                   ...
                   >
                     <SelectTrigger className={cn("w-full", errors.hepatitisBResult && "border-red-500")}>
                       <SelectValue placeholder="Select result" />
                     </SelectTrigger>
                     <SelectContent>
                       {RESULT_OPTIONS.map((result) => (
             ...
             <div className="space-y-2">
               ...
               <Controller
                 ...
                 render={({ field }) => (
                   ...
                   >
                     <SelectTrigger className={cn("w-full", errors.hepatitisCResult && "border-red-500")}>
                       <SelectValue placeholder="Select result" />
                     </SelectTrigger>
                     <SelectContent>
                       {RESULT_OPTIONS.map((result) => (
             ...
             >
               {saveLoading || isSubmitting ? (
                 <>
                   ...
                   {isSubmitting ? 'Validating...' : 'Updating results...'}
                 </>
               ) : (
                 <>
